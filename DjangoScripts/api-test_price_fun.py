...
# import datetime.timedelta as tdlt
...
file = io.open("prices.log", mode='w')
# get the values and store them 10 times, over 17 day spans
for jvar in range (0, 10) :
    print("Run %d." % (jvar + 1))
    # d1 = date(2015, 9, 1) + timedelta(18 * jvar)
    # d2 = date(2015, 9, 18) + timedelta(18 * jvar)
    d1 = dt.date(2015, 9, 1) + dt.timedelta(18 * jvar)
    d2 = dt.date(2015, 9, 18) + dt.timedelta(18 * jvar)
    ...
    # file.write(closing_prices + '\n')
    pprint(closing_prices, file)
    urllib2.urlclose()
